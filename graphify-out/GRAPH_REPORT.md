# Graph Report - worldorder  (2026-07-27)

## Corpus Check
- 285 files · ~609,534 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3333 nodes · 9218 edges · 205 communities (191 shown, 14 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1123 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f889feeb`
...
1. `Event` - 184 edges
2. `Settings` - 142 edges
3. `RngRegistry` - 127 edges
4. `NewEvent` - 126 edges
5. `AgentPopulation` - 120 edges
6. `World` - 110 edges
7. `Action` - 109 edges
8. `load_settings()` - 108 edges
9. `VentureEngine` - 78 edges
10. `LLMRouter` - 72 edges
...
- `_GateEventSink` --uses--> `Settings`  [INFERRED]
  scripts/validate_m3_multiseed.py → polis/config/settings.py
...
Cohesion: 0.18
Nodes (13): reflect_decide(), _candidates(), reflex_decide(), Agent state and cognition., AgentState, Needs, ReflexProfile, Traits (+5 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (65): ConfigError, MechanismError, ProfileNotFound, A requested configuration profile does not exist., A mechanism registration is invalid., A runtime policy overlay violates temporal rules., Configuration cannot be loaded or validated., RuntimeOverlayError (+57 more)

### Community 2 - "Community 2"
Cohesion: 0.19
Nodes (10): EventQuery, UUID, rebuild(), RebuildReport, snapshot_projections(), _event(), EventRepository, Any (+2 more)
...
Cohesion: 0.13
Nodes (33): dtype, EducationLevel, EmploymentStatus, PlaceType, _age(), _education(), _employment(), generate_agents() (+25 more)

### Community 5 - "Community 5"
Cohesion: 0.19
Nodes (11): create_economy(), _firm_place(), GenesisResult, UUID, _weighted_ids(), compute_world_hash(), District, Place (+3 more)

### Community 6 - "Community 6"
Cohesion: 0.14
Nodes (10): AsyncConnectionPool, Database, HealthReport, Any, AsyncConnection, Persistence and projection repositories., LedgerRepository, Any (+2 more)
...
Cohesion: 0.13
Nodes (15): CliProvider, _finish_reason(), parse_codex_jsonl(), parse_grok_json(), Decimal, HealthReport, Path, _safe_environment() (+7 more)

### Community 9 - "Community 9"
Cohesion: 0.18
Nodes (16): ActionOrigin, Resolution, resolve_actions(), make_action(), Any, action_response_schema(), Any, Create deterministic institutional market sells before the exchange resolves. (+8 more)
...
Cohesion: 0.12
Nodes (28): Capabilities, HealthReport, ProviderError, ProviderPermanent, ProviderTimeout, ProviderTransient, Provider deadline expired., Provider request failed. (+20 more)

### Community 12 - "Community 12"
Cohesion: 0.14
Nodes (50): BankingEngine, WithdrawalRequest, apply_pending_policy(), CentralContext, _credit_context(), discount_window(), _originate_interbank(), policy_rate_target_bp() (+42 more)
...
Cohesion: 0.20
Nodes (23): _combine_legs(), cpi_bp(), _deposit_account(), _district_distance(), GoodsContext, _index_for(), load_skus(), plan_budget() (+15 more)
...
Cohesion: 0.12
Nodes (23): PolisError, Exception, Base exception for expected POLIS failures., cache_key(), CacheMissInReplay, CacheRecord, CacheRenderMismatch, CacheVersionMismatch (+15 more)

### Community 17 - "Community 17"
Cohesion: 0.20
Nodes (18): deliberate_decide(), render_prompt(), AgentBrief, build_observations(), _legal_actions(), Observation, PlaceView, datetime (+10 more)

### Community 18 - "Community 18"
Cohesion: 0.29
Nodes (9): FastAPI, datetime, Return wall time for operational metadata, never simulation state., utc_now_naive(), _freshness(), _json_row(), Any, UUID (+1 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (23): apply_client_message(), live_channel(), LiveClient, LiveHub, Any, UUID, RedisEphemeralPublisher, Redis (+15 more)
...
### Community 24 - "Lane"
Cohesion: 0.13
Nodes (20): build_lanes(), Lane, AsyncClient, UUID, ProviderRateLimited, Path, quota_path(), SlidingWindowQuota (+12 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (57): _annual_difference_sign_changes(), _annual_means(), _annual_terminal_values(), evaluate_v1(), evaluate_v2(), evaluate_v3(), _failure_summary(), GateResult (+49 more)

### Community 26 - "Community 26"
Cohesion: 0.22
Nodes (8): Delivered, Engineering evidence, Gates still open, Live calibration evidence, Live-provider pilot completed, M3 Capital acceptance, Stage 0 mechanical calibration, Stage 3 diagnostic

### Community 27 - "invariants.py"
Cohesion: 0.26
Nodes (12): check_money(), EconomyView, issued_base_money_cents(), m0_cents(), m1_cents(), Protocol, StrEnum, Severity (+4 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (8): Emit, FirmEngine, Emit, Emit, LabourMarket, progressive_income_tax_cents(), Emit, NewEvent

### Community 29 - "goods.py"
Cohesion: 0.21
Nodes (14): is_ephemeral(), KindError, KindRange, KindSpec, Persistence, Any, StrEnum, range_for() (+6 more)
...
Cohesion: 0.11
Nodes (17): Append-only event log contracts., CommitResult, EphemeralSink, EventLog, EventSink, MemoryEventSink, NullEphemeralSink, Protocol (+9 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (22): _age_factor(), apply_education(), SkillDelta, AgentPopulation, Any, labour_force(), LabourForce, should_autopost() (+14 more)

### Community 34 - "EventRepository"
Cohesion: 0.15
Nodes (32): repo_git_sha(), config_hash(), _config_payload(), config_yaml(), reproducibility_tuple(), Settings, create_app(), run_id_for() (+24 more)

### Community 35 - "RuntimeConfig"
Cohesion: 0.24
Nodes (10): CommitmentLedger, cause(), opened_ledger(), UUID, test_account_ids_are_canonical_and_parseable(), test_checkpoint_roundtrip_restores_exact_state(), test_commitment_ledger_prevents_intra_tick_double_spend(), test_post_rejects_unknown_closed_overdrawn_and_wrong_tick() (+2 more)

### Community 36 - "load_settings"
Cohesion: 0.25
Nodes (12): active_mechanisms(), mechanism_manifest(), MechanismSpec, run_living_city(), test_fast_50_agent_500_tick_smoke(), test_frozen_50_agent_100_tick_golden_run(), test_metrics_only_retention_keeps_only_sampled_cognition_traces(), settings() (+4 more)
...
Cohesion: 0.08
Nodes (32): redundancy_order(), AcquisitionState, BankruptcyCaseState, CapTableState, ClaimState, FundingRoundState, PitchState, StartupState (+24 more)
...
Cohesion: 0.10
Nodes (13): AccountCode, Deterministic economic institutions for POLIS., Account, account_id(), Entry, Ledger, LedgerError, LedgerRepository (+5 more)
...
Cohesion: 0.16
Nodes (15): active_employment(), load_occupations(), match_score_bp(), Occupation, Path, _skill_bp(), _skill_mapping(), skill_value_bp() (+7 more)
...
Cohesion: 0.07
Nodes (26): Bank resolution and tax arrears, Bootstrap issuance boundary, Bounded reflection backlog, Coding CLIs are bounded provider probes, not simulation workers, CPI base includes contemporaneous policy, Event stakes are not chronic need pressure, Genesis deposit and central-bank settlement, Goods-kind renumbering (+18 more)
...
Cohesion: 0.20
Nodes (16): ancestors(), CausalNode, descendants(), explain(), has_ancestor_in_range(), Any, UUID, EventReader (+8 more)
...
Cohesion: 0.12
Nodes (3): Invariant, Protocol, WorldStateView
...
Cohesion: 0.14
Nodes (31): assess_taxes(), close_budget(), collect_taxes(), convert_arrears(), finance_deficit(), fiscal_step(), FiscalContext, government_transfer_legs() (+23 more)

### Community 118 - "README.md"
Cohesion: 0.16
Nodes (18): K, canonical_bytes(), canonical_json(), Any, T, round6(), round_floats(), det_id() (+10 more)
...
Cohesion: 0.13
Nodes (18): _cap_table(), _capital_result(), _chain(), _entropy(), _FunctionInvariant, _interest(), InvariantRunner, _ledger() (+10 more)
...
Cohesion: 0.17
Nodes (8): _bp_ceil(), _coalesce(), ExchangeEngine, Any, Emit, Deterministic, reservation-backed exchange implementation., SecurityState, Event

### Community 183 - "Ledger"
Cohesion: 0.13
Nodes (28): F, mechanism(), ExchangeState, add_inventory(), markup_price(), split_labour_by_revenue(), update_productivity_bp(), sector_skus() (+20 more)
...
Cohesion: 0.29
Nodes (8): Counter, load_settings(), action_counts(), test_frozen_m3_100_tick_golden_covers_every_leg_family(), test_m3_acceptance_path_is_complete_and_deterministic(), test_non_fixture_mechanical_market_bootstraps_and_trades_deterministically(), test_m2_metrics_follow_declared_cadences_and_use_live_economy(), test_m3_metrics_use_exchange_dividends_and_fund_cash_flows()

### Community 187 - "Scheduler"
Cohesion: 0.07
Nodes (32): IntEnum, Deliberation, Reflection, ClockSettings, Clock, profile_from_settings(), Any, datetime (+24 more)
...
Cohesion: 0.15
Nodes (14): MemoryType, embed_text(), MemoryRecord, MemoryStore, _normalise(), Any, ReflectionInsight, Retrieval (+6 more)

### Community 191 - "central.py"
Cohesion: 0.29
Nodes (19): LoanDecision, parse_account_id(), build(), configured(), emit_at(), found_startup(), test_absorb_integration_pays_redundancy_and_transfers_loan_obligor(), test_acquisition_anchor_and_synergy_ablations_change_runtime_behavior() (+11 more)

### Community 193 - "MechanicalPolicy"
Cohesion: 0.13
Nodes (22): Admission, StrEnum, Provider-neutral LLM routing., Purpose, StrEnum, CallRequest, CallResult, dataclass_replace() (+14 more)

### Community 194 - "test_exchange_properties.py"
Cohesion: 0.18
Nodes (23): ask_priority(), bid_priority(), call_auction(), continuous_matches(), crosses(), Fill, uncross(), HoldingState (+15 more)

### Community 195 - "test_stub.py"
Cohesion: 0.14
Nodes (21): CompletionRequest, legal_actions_from_prompt(), _pick(), Any, BaseModel, Decimal, HealthReport, Deterministic mandatory test provider; never performs I/O or reads ambient state (+13 more)

### Community 196 - "CacheSettings"
Cohesion: 0.12
Nodes (20): LocalBlobStore, open_blobs(), Path, MigrationMismatch, Persistence layer failure., The database migration head does not match the application., A reader or unauthorized module attempted a write., StoreError (+12 more)

### Community 197 - "_event"
Cohesion: 0.60
Nodes (4): check_ledger(), Result, event(), test_random_affordable_transfer_sequences_keep_the_book_closed()
...
## Knowledge Gaps
- **1160 isolated node(s):** `$schema`, `type`, `action`, `reasoning`, `confidence` (+1155 more)
...
- **Why does `Event` connect `ExchangeEngine` to `Community 2`, `Community 5`, `Community 12`, `Community 14`, `Community 19`, `Community 25`, `invariants.py`, `Community 28`, `goods.py`, `Community 32`, `RuntimeConfig`, `Community 41`, `Community 53`, `Ledger`, `Scheduler`, `rebuild.py`, `test_router_repair.py`, `test_exchange_properties.py`, `test_ventures.py`, `_event`, `hashing.py`, `Event`, `Clock`, `EventReader`, `fiscal.py`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Settings` connect `EventRepository` to `Community 1`, `Community 5`, `Community 7`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Lane`, `Community 25`, `Community 28`, `Community 32`, `Community 33`, `load_settings`, `Community 41`, `ExchangeEngine`, `Ledger`, `NullWorldState`, `partition.py`, `Scheduler`, `central.py`, `test_router_repair.py`, `MechanicalPolicy`, `test_exchange_properties.py`, `test_ventures.py`, `Clock`, `fiscal.py`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `PolisError` connect `Community 16` to `Community 1`, `RuntimeConfig`, `test_stub.py`, `CacheSettings`, `Community 6`, `engine.py`, `Community 11`, `Community 12`, `Any`, `Community 53`, `Lane`, `goods.py`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Are the 54 inferred relationships involving `Settings` (e.g. with `RoutingResult` and `SalienceScore`) actually correct?**
